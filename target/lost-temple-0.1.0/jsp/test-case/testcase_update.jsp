...
<script>	
	...
	$(".testcaseupdate #submit").on("click",function(){		
		if(!validInput()){
			return;
		}
		$(".testcaseupdate #postForm").submit();
	});

</script>

<div class="pageContent testcaseupdate">
	<form method="post" id="postForm" action="testcase/update" class="pageForm required-validate"
