...
<div id="globaldata" class="pageContent">	
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="#" onclick="addRow('globaldata', 'globaldataTable')"><span>新增</span></a></li>
			<li><a class="add" href="#" onclick="saveXml('globaldata', 'globaldataTable', 'testdata/global/save')"><span>保存</span></a></li>
		</ul>
		...
		<tbody id="globaldataTable">
 			<c:forEach var="item" items="${list}" varStatus="index">
				<tr id="${index.count}">
					...
					<td>
                    	<a class="btnDel" href="#" onclick="deleteRow('globaldata', '${index.count}')">删除</a>     
                	</td>
				</tr> 			
			</c:forEach>
		</tbody>
